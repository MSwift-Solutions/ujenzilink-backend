...
public class PassActionsService {
        ...
        public ApiCustomResponse<String> requestPasswordReset(ForgotPassResetRequest request) {
                ...
                return new ApiCustomResponse<>(
                                null,
                                "Password reset code has been sent to " + user.getEmail(),
                                HttpStatus.OK.value());
        }
        ...
        public ApiCustomResponse<String> confirmResetCode(CodeConfirmRequest request) {
                ...
                PasswordActionToken tokenData = passwordActionTokenRepository.findById(request.resetCode())
                                .orElse(null);
                ...
                PasswordAction passwordAction = passwordActionRepository
                                .findTopByUserAndActionTypeOrderByActionDateDesc(user,
                ...
                return new ApiCustomResponse<>(
                                null,
                                "Reset code confirmed successfully.",
                                HttpStatus.OK.value());
        }
        ...
        public ApiCustomResponse<String> resetPassword(ForgotPassResetNew request) {
                ...
                if (passwordAction == null || !passwordAction.getCodeConfirmed()) {
                        return new ApiCustomResponse<>(
                                        null,
                                        "Reset code must be confirmed before resetting password.",
                                        HttpStatus.FORBIDDEN.value());
                }
